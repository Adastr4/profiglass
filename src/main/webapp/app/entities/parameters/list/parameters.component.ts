...
export class ParametersComponent implements OnInit {
  ...
  constructor(protected parametersService: ParametersService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.parameters = [];
  ...
  trackId(index: number, item: IParameters): number {
    return item.id!;
  }
  ...
  protected paginateParameters(data: IParameters[] | null, headers: HttpHeaders): void {
