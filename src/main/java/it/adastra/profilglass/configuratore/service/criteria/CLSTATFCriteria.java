...
/**
 * Criteria class for the {@link it.adastra.profilglass.configuratore.domain.CLSTATF} entity. This class is used
 * in {@link it.adastra.profilglass.configuratore.web.rest.CLSTATFResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /clstatfs?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CLSTATFCriteria implements Serializable, Criteria {
    ...
    public CLSTATFCriteria() {}

    public CLSTATFCriteria(CLSTATFCriteria other) {
    ...
    @Override
    public CLSTATFCriteria copy() {
        return new CLSTATFCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CLSTATFCriteria that = (CLSTATFCriteria) o;
